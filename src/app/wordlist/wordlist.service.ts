...
export class WordlistService {
  ...
  private wordScore(word: string): number {
    ...
    for (const letter in WordlistService._letterRanking) {
      if (word.includes(letter)) {
        score += WordlistService._letterRanking[letter];
      }
    }
  ...
  // letter ranking pulled from here: https://www3.nd.edu/~busiforc/handouts/cryptography/letterfrequencies.html
  private static _letterRanking: {
    [x: string]: number
  } = {
      'e': 56.88,
      'a': 43.31,
